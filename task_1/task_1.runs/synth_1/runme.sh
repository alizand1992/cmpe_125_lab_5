...
HD_PWD='C:/Users/Ali/Documents/cmpe_125_lab_5/task_1/task_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_fpga.tcl
