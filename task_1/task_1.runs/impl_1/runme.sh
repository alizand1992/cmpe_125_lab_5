...
HD_PWD='C:/Users/Ali/Documents/cmpe_125_lab_5/task_1/task_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_fpga.tcl -notrace
